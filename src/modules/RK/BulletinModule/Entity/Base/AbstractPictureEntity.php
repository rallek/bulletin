...
abstract class AbstractPictureEntity extends EntityAccess
{
     ...
     * @Assert\NotBlank()
     * @BulletinAssert\ListEntry(entityName="picture", propertyName="workflowState", multiple=false)
    ...
    /**
     * Bidirectional - Many pictures [pictures] are linked by one notice [notice] (OWNING SIDE).
     *
     * @ORM\ManyToOne(targetEntity="RK\BulletinModule\Entity\NoticeEntity", inversedBy="pictures")
    ...
    {
        return 'rkbulletinmodule.ui_hooks.pictures';
    }
