...
namespace RK\BulletinModule\Block\Base;
...
abstract class AbstractItemListBlock extends AbstractBlockHandler
{
    ...
    public function display(array $properties)
    {
        ...
        if (!$this->hasPermission('RKBulletinModule:ItemListBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return false;
        }
        ...
        if (empty($properties['title'])) {
            $properties['title'] = $this->__('RKBulletinModule items');
        }
    ...
    {
        return 'RK\BulletinModule\Block\Form\Type\ItemListBlockType';
    }
    ...
    {
        return '@RKBulletinModule/Block/itemlist_modify.html.twig';
    }
