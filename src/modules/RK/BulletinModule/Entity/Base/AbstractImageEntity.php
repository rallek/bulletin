...
abstract class AbstractImageEntity extends EntityAccess
{
    ...
    /**
     * the text is filling the alt tag of the image
     * @ORM\Column(length=255)
     * @Assert\NotBlank()
     * @Assert\Length(min="0", max="255")
     * @var string $altText
    ...
    /**
     * Bidirectional - Many addresses [images] are linked by one person [notice] (OWNING SIDE).
     *
     * @ORM\ManyToOne(targetEntity="RK\BulletinModule\Entity\NoticeEntity", inversedBy="addresses")
     * @ORM\JoinTable(name="rk_bulletin_notice")
     * @Assert\Type(type="RK\BulletinModule\Entity\NoticeEntity")
     * @var \RK\BulletinModule\Entity\NoticeEntity $person
     */
    protected $person;
    ...
    {
        $this->altText = isset($altText) ? $altText : '';
    }
     ...
     * Sets the person.
     *
     * @param \RK\BulletinModule\Entity\NoticeEntity $person
     *
     * @return void
     */
    ...
    {
        return 'rkbulletinmodule.ui_hooks.images';
    }
