...
namespace RK\BulletinModule\Form\Plugin\Base;
...
class AbstractItemSelector extends Zikula_Form_Plugin_TextInput implements ContainerAwareInterface
{
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        if ($firstTime) {
            ...
            $jsAssetBag->add($assetHelper->resolve('@RKBulletinModule:js/RKBulletinModule.js'));
            $jsAssetBag->add($assetHelper->resolve('@RKBulletinModule:js/RKBulletinModule.Finder.js'));
        ...
        if (!$permissionApi->hasPermission('RKBulletinModule:' . ucfirst($this->objectType) . ':', '::', ACCESS_COMMENT)) {
            return false;
        }
    ...
    public function decode(Zikula_Form_View $view)
    {
        ...
        $this->objectType = $request->request->get('RKBulletinModule_objecttype', 'notice');
