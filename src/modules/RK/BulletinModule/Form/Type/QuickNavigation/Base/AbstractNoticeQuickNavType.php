...
namespace RK\BulletinModule\Form\Type\QuickNavigation\Base;
...
/**
 * Notice quick navigation form type base class.
 */
abstract class AbstractNoticeQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    /**
     * NoticeQuickNavType constructor.
     *
    ...
    public function addCategoriesField(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('categories', 'Zikula\CategoriesModule\Form\Type\CategoriesType', [
            ...
            'entityCategoryClass' => 'RK\BulletinModule\Entity\\' . ucfirst($objectType) . 'CategoryEntity'
        ]);
    }
    ...
    {
        $listEntries = $this->listHelper->getEntries('notice', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
        ...
        $builder
            ->add('sort', 'Symfony\Component\Form\Extension\Core\Type\ChoiceType', [
                ...
                'choices' =>             [
                    ...
                    $this->__('Event date time') => 'eventDateTime',
    ...
    {
        return 'rkbulletinmodule_noticequicknav';
    }
}
