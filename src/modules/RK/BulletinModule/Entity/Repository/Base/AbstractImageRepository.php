...
abstract class AbstractImageRepository extends EntityRepository
{
    ...
    protected function getViewQuickNavParameters($context = '', $args = [])
    {
        ...
        $parameters = [];
        $parameters['person'] = $this->getRequest()->query->get('person', 0);
    ...
    public function truncateTable(LoggerInterface $logger)
    {
        ...
        $qb->delete('RK\BulletinModule\Entity\ImageEntity', 'tbl');
        $query = $qb->getQuery();
    
        $query->execute();
    
        $logArgs = ['app' => 'RKBulletinModule', 'entity' => 'image'];
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApi $currentUserApi)
    {
        ...
        $qb = $this->getEntityManager()->createQueryBuilder();
        $qb->update('RK\BulletinModule\Entity\ImageEntity', 'tbl')
        ...
        $logArgs = ['app' => 'RKBulletinModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'images', 'userid' => $userId];
    ...
    protected function getCountQuery($where = '', $useJoins = true)
    {
        ...
        $qb = $this->getEntityManager()->createQueryBuilder();
        $qb->select($selection)
           ->from('RK\BulletinModule\Entity\ImageEntity', 'tbl');
    ...
    {
        $qb->leftJoin('tbl.person', 'tblPerson');
