    ...
    public function getCustomRuntimeOptions($objectType = '', $fieldName = '', $contextName = '', $context = '', $args = [])
    {
        $options = [
            'thumbnail' => [
                ...
                'mode'      => $this->variableApi->get('RKBulletinModule', 'thumbnailMode' . ucfirst($objectType) . ucfirst($fieldName), 'inset'),
        ...
        if ($contextName == $this->name . '_relateditem') {
            ...
            if (in_array($args['action'], ['view', 'display', 'edit'])) {
                ...
                $options['thumbnail']['size'] = [
                    $this->variableApi->get('RKBulletinModule', 'thumbnailWidth' . $fieldSuffix, $defaultWidth),
                    $this->variableApi->get('RKBulletinModule', 'thumbnailHeight' . $fieldSuffix, $defaultHeight)
                ];
            }
        }
