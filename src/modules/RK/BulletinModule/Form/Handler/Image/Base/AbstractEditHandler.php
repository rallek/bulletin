...
namespace RK\BulletinModule\Form\Handler\Image\Base;
...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    protected function initRelationPresets()
    {
        ...
        $this->relationPresets['person'] = $this->request->get('person', '');
        if (!empty($this->relationPresets['person'])) {
            $relObj = $this->selectionHelper->getEntity('notice', $this->relationPresets['person']);
            if (null !== $relObj) {
                $relObj->addAddresses($entity);
            }
        }
    ...
    protected function createForm()
    {
        ...
        return $this->formFactory->create('RK\BulletinModule\Form\Type\ImageType', $this->entityRef, $options);
    }
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'RKBulletinModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'image', 'id' => $entity->createCompositeIdentifier(), 'errorMessage' => $e->getMessage()];
    ...
    protected function getRedirectUrl($args)
    {
        ...
        switch ($this->returnTo) {
            ...
            case 'adminDisplayNotice':
                if (!empty($this->relationPresets['person'])) {
                    return $this->router->generate('rkbulletinmodule_notice_' . $routeArea . 'display',  ['id' => $this->relationPresets['person']]);
                }
