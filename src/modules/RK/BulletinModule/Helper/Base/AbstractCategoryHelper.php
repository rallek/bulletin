...
abstract class AbstractCategoryHelper
{
    ...
    public function retrieveCategoriesFromRequest($objectType = '', $source = 'POST')
    {
        ...
        $inputValues = null;
        $inputName = 'rkbulletinmodule_' . strtolower($objectType) . 'quicknav';
        if (!$dataSource->has($inputName)) {
            $inputName = 'rkbulletinmodule_' . strtolower($objectType) . 'finder';
        }
        if ($dataSource->has($inputName)) {
    ...
    public function getAllProperties($objectType = '')
    {
        ...
        return $this->categoryRegistryApi->getModuleRegistriesIds('RKBulletinModule', ucfirst($objectType) . 'Entity');
    }
    ...
    public function getAllPropertiesWithMainCat($objectType = '', $arrayKey = 'property')
    {
        ...
        return $this->categoryRegistryApi->getModuleCategoryIds('RKBulletinModule', ucfirst($objectType) . 'Entity', $arrayKey);
    }
    ...
    public function getMainCatForProperty($objectType = '', $property = '')
    {
        ...
        return $this->categoryRegistryApi->getModuleCategoryId('RKBulletinModule', ucfirst($objectType) . 'Entity', $property);
    }
