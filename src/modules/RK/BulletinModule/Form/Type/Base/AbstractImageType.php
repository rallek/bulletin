...
abstract class AbstractImageType extends AbstractType
{
     ...
     */
    public function __construct(TranslatorInterface $translator, BulletinFactory $entityFactory, ListEntriesHelper $listHelper, FeatureActivationHelper $featureActivationHelper)
    {
    ...
    public function addEntityFields(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('altText', 'Symfony\Component\Form\Extension\Core\Type\TextType', [
            'label' => $this->__('Alt text') . ':',
            'label_attr' => [
                'class' => 'tooltips',
                'title' => $this->__('the text is filling the alt tag of the image')
            ],
            'help' => $this->__('the text is filling the alt tag of the image'),
            'empty_data' => '',
            'attr' => [
                'maxlength' => 255,
                'class' => '',
                'title' => $this->__('Enter the alt text of the image')
            ],
            'required' => true,
        ]);
    }
    ...
    public function addIncomingRelationshipFields(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('person', 'Symfony\Bridge\Doctrine\Form\Type\EntityType', [
            'class' => 'RKBulletinModule:NoticeEntity',
            ...
            'required' => false,
            'label' => $this->__('Person'),
            'attr' => [
                'title' => $this->__('Choose the person')
            ]
        ]);
    }
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver
            ->setDefaults([
                ...
                'data_class' => 'RK\BulletinModule\Entity\ImageEntity',
