...
abstract class AbstractPictureType extends AbstractType
{
    ...
    public function addEntityFields(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('altText', 'Symfony\Component\Form\Extension\Core\Type\TextType', [
            ...
            'attr' => [
                'maxlength' => 255,
                'class' => '',
                'title' => $this->__('Enter the alt text of the picture')
            ],
            'required' => false,
        ]);
    }
    ...
    public function addIncomingRelationshipFields(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('notice', 'Symfony\Bridge\Doctrine\Form\Type\EntityType', [
    ...
    {
        return 'rkbulletinmodule_picture';
    }
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver
            ->setDefaults([
                ...
                'data_class' => 'RK\BulletinModule\Entity\PictureEntity',
