...
abstract class AbstractImageController extends AbstractController
{
    ...
    protected function indexInternal(Request $request, $isAdmin = false)
    {
        ...
        return $this->redirectToRoute('rkbulletinmodule_image_' . $templateParameters['routeArea'] . 'view');
        
        // return index template
        return $this->render('@RKBulletinModule/Image/index.html.twig', $templateParameters);
    }
    /**
    ...
    protected function viewInternal(Request $request, $sort, $sortdir, $pos, $num, $isAdmin = false)
    {
        ...
        $sortableColumns = new SortableColumns($this->get('router'), 'rkbulletinmodule_image_' . ($isAdmin ? 'admin' : '') . 'view', 'sort', 'sortdir');
     ...
     * @ParamConverter("image", class="RKBulletinModule:ImageEntity", options = {"id" = "id", "repository_method" = "selectById"})
    ...
    protected function editInternal(Request $request, $isAdmin = false)
    {
        ...
        $formHandler = $this->get('rk_bulletin_module.form.handler.image');
    ...
    protected function deleteInternal(Request $request, ImageEntity $image, $isAdmin = false)
    {
        ...
        $logArgs = ['app' => 'RKBulletinModule', 'user' => $this->get('zikula_users_module.current_user')->get('uname'), 'entity' => 'image', 'id' => $image->createCompositeIdentifier()];
        ...
        $redirectRoute = 'rkbulletinmodule_image_' . ($isAdmin ? 'admin' : '') . 'view';
        ...
        $form = $this->createForm('RK\BulletinModule\Form\DeleteEntityType', $image);
    ...
    protected function handleSelectedEntriesActionInternal(Request $request, $isAdmin = false)
    {
        ...
        foreach ($items as $itemid) {
            ...
            try {
                ...
                $logger->error('{app}: User {user} tried to execute the {action} workflow action for the {entity} with id {id}, but failed. Error details: {errorMessage}.', ['app' => 'RKBulletinModule', 'user' => $userName, 'action' => $action, 'entity' => 'image', 'id' => $itemid, 'errorMessage' => $e->getMessage()]);
            }
            ...
            if ($action == 'delete') {
                $this->addFlash('status', $this->__('Done! Item deleted.'));
                $logger->notice('{app}: User {user} deleted the {entity} with id {id}.', ['app' => 'RKBulletinModule', 'user' => $userName, 'entity' => 'image', 'id' => $itemid]);
            } else {
                $this->addFlash('status', $this->__('Done! Item updated.'));
                $logger->notice('{app}: User {user} executed the {action} workflow action for the {entity} with id {id}.', ['app' => 'RKBulletinModule', 'user' => $userName, 'action' => $action, 'entity' => 'image', 'id' => $itemid]);
            }
            ...
            if ($action != 'delete') {
                ...
                $url = new RouteUrl('rkbulletinmodule_image_' . /*($isAdmin ? 'admin' : '') . */'display', $urlArgs);
            }
            $hookHelper->callProcessHooks($entity, $hookType, $url);
        }
        
        return $this->redirectToRoute('rkbulletinmodule_image_' . ($isAdmin ? 'admin' : '') . 'index');
    }
}
