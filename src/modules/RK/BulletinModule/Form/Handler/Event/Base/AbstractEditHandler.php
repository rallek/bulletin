...
namespace RK\BulletinModule\Form\Handler\Event\Base;
...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    protected function createForm()
    {
        ...
        return $this->formFactory->create('RK\BulletinModule\Form\Type\EventType', $this->entityRef, $options);
    }
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'RKBulletinModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'event', 'id' => $entity->createCompositeIdentifier(), 'errorMessage' => $e->getMessage()];
