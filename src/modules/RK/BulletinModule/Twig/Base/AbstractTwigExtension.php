...
namespace RK\BulletinModule\Twig\Base;
...
abstract class AbstractTwigExtension extends Twig_Extension
{
    ...
    {
        return [
            new \Twig_SimpleFunction('rkbulletinmodule_objectTypeSelector', [$this, 'getObjectTypeSelector']),
            new \Twig_SimpleFunction('rkbulletinmodule_templateSelector', [$this, 'getTemplateSelector']),
            new \Twig_SimpleFunction('rkbulletinmodule_userAvatar', [$this, 'getUserAvatar'], ['is_safe' => ['html']])
        ];
    }
    ...
    {
        return [
            new \Twig_SimpleFilter('rkbulletinmodule_fileSize', [$this, 'getFileSize'], ['is_safe' => ['html']]),
            new \Twig_SimpleFilter('rkbulletinmodule_listEntry', [$this, 'getListEntry']),
            new \Twig_SimpleFilter('rkbulletinmodule_objectState', [$this, 'getObjectState'], ['is_safe' => ['html']])
        ];
    }
    
    /**
     * The rkbulletinmodule_objectState filter displays the name of a given object's workflow state.
     * Examples:
     *    {{ item.workflowState|rkbulletinmodule_objectState }}        {# with visual feedback #}
     *    {{ item.workflowState|rkbulletinmodule_objectState(false) }} {# no ui feedback #}
     *
    ...
    /**
     * The rkbulletinmodule_fileSize filter displays the size of a given file in a readable way.
     * Example:
     *     {{ 12345|rkbulletinmodule_fileSize }}
     *
    ...
    /**
     * The rkbulletinmodule_listEntry filter displays the name
     * or names for a given list item.
     * Example:
     *     {{ entity.listField|rkbulletinmodule_listEntry('entityName', 'fieldName') }}
     *
    ...
    /**
     * The rkbulletinmodule_objectTypeSelector function provides items for a dropdown selector.
     *
    ...
    /**
     * The rkbulletinmodule_templateSelector function provides items for a dropdown selector.
     *
     * @return string The output of the plugin
     */
    ...
    public function getUserAvatar($uid = 0, $width = 0, $height = 0, $size = 0, $rating = '')
    {
        ...
        $view = \Zikula_View::getInstance('RKBulletinModule');
