...
abstract class AbstractPictureRepository extends EntityRepository
{
    ...
    public function truncateTable(LoggerInterface $logger)
    {
        ...
        $qb->delete('RK\BulletinModule\Entity\PictureEntity', 'tbl');
        $query = $qb->getQuery();
    
        $query->execute();
    
        $logArgs = ['app' => 'RKBulletinModule', 'entity' => 'picture'];
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApi $currentUserApi)
    {
        ...
        $qb = $this->getEntityManager()->createQueryBuilder();
        $qb->update('RK\BulletinModule\Entity\PictureEntity', 'tbl')
        ...
        $logArgs = ['app' => 'RKBulletinModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'pictures', 'userid' => $userId];
    ...
    protected function applyDefaultFilters(QueryBuilder $qb, $parameters = [])
    {
        ...
        $isAdminArea = false !== strpos($routeName, 'rkbulletinmodule_picture_admin');
        if ($isAdminArea) {
            return $qb;
        }
    ...
    protected function addSearchFilter(QueryBuilder $qb, $fragment = '')
    {
        ...
        $filters[] = 'tbl.altText LIKE :searchAltText';
        $parameters['searchAltText'] = '%' . $fragment . '%';
    ...
    protected function getCountQuery($where = '', $useJoins = false)
    {
        ...
        $qb = $this->getEntityManager()->createQueryBuilder();
        $qb->select($selection)
           ->from('RK\BulletinModule\Entity\PictureEntity', 'tbl');
