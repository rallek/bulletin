...
namespace RK\BulletinModule\Form\Handler\Notice\Base;
 ...
 * It aims on the notice object type.
 */
abstract class AbstractEditHandler extends EditHandler
{
    ...
    public function processForm(array $templateParameters)
    {
        ...
        $this->objectTypeCapital = 'Notice';
        $this->objectTypeLower = 'notice';
        ...
        if ($this->templateParameters['mode'] == 'create') {
            if (!$this->modelHelper->canBeCreated($this->objectType)) {
                $this->request->getSession()->getFlashBag()->add('error', $this->__('Sorry, but you can not create the notice yet as other items are required which must be created before!'));
    ...
    protected function getRedirectCodes()
    {
        ...
        // user index page of notice area
        $codes[] = 'userIndex';
        // admin index page of notice area
        $codes[] = 'adminIndex';
        ...
        $codes[] = 'adminOwnView';
        // user detail page of treated notice
        $codes[] = 'userDisplay';
        // admin detail page of treated notice
        $codes[] = 'adminDisplay';
        ...
        switch ($args['commandName']) {
            ...
            case 'submit':
                if ($this->templateParameters['mode'] == 'create') {
                    ...
                    $message = $this->__('Done! Notice updated.');
                }
                break;
            case 'delete':
                $message = $this->__('Done! Notice deleted.');
                break;
            default:
                $message = $this->__('Done! Notice updated.');
                break;
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'RKBulletinModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'notice', 'id' => $entity->createCompositeIdentifier(), 'errorMessage' => $e->getMessage()];
