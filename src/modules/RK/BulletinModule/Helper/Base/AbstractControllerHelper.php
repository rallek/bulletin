...
abstract class AbstractControllerHelper
{
    ...
    /**
     * Returns an array of all allowed object types in RKBulletinModule.
     *
    ...
    /**
     * Returns the default object type in RKBulletinModule.
     *
     * @param string $context Usage context (allowed values: controllerAction, api, helper, actionHandler, block, contentType, util)
     * @param array  $args    Additional arguments
     *
    ...
    public function processViewActionParameters($objectType, SortableColumns $sortableColumns, array $templateParameters = [], $supportsHooks = false)
    {
        ...
        $showOwnEntries = $request->query->getInt('own', $this->variableApi->get('RKBulletinModule', 'showOnlyOwnEntries', 0));
        ...
        if ($showAllEntries != 1) {
            ...
            if (in_array($resultsPerPage, [0, 10])) {
                $resultsPerPage = $this->variableApi->get('RKBulletinModule', $objectType . 'EntriesPerPage', 10);
            }
        }
        ...
        $quickNavForm = $this->formFactory->create('RK\BulletinModule\Form\Type\QuickNavigation\\' . ucfirst($objectType) . 'QuickNavType', $templateParameters);
        ...
        if (true === $supportsHooks) {
            ...
            $currentUrlObject = new RouteUrl('rkbulletinmodule_' . $objectType . '_' . /*$templateParameters['routeArea'] . */'view', $currentUrlArgs);
        }
    ...
    public function processDisplayActionParameters($objectType, array $templateParameters = [], $supportsHooks = false)
    {
        ...
        if (true === $supportsHooks) {
            ...
            $currentUrlObject = new RouteUrl('rkbulletinmodule_' . $objectType . '_' . /*$templateParameters['routeArea'] . */'display', $currentUrlArgs);
            $templateParameters['currentUrlObject'] = $currentUrlObject;
        }
