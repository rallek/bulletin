...
namespace RK\BulletinModule\ContentType\Base;
...
abstract class AbstractItemList extends \Content_AbstractContentType implements ContainerAwareInterface
{
    ...
    {
        return $this->container->get('translator.default')->__('RKBulletinModule list view');
    }
    ...
    {
        return $this->container->get('translator.default')->__('Display list of RKBulletinModule objects.');
    }
    ...
    {
        $controllerHelper = $this->container->get('rk_bulletin_module.controller_helper');
    ...
    {
        $repository = $this->container->get('rk_bulletin_module.entity_factory')->getRepository($this->objectType);
        ...
        $imageHelper = $this->container->get('rk_bulletin_module.image_helper');
    ...
    protected function getDisplayTemplate()
    {
        ...
        foreach ($templateOptions as $templatePath) {
            if ($templating->exists('@RKBulletinModule/' . $templatePath)) {
                $template = '@RKBulletinModule/' . $templatePath;
                break;
            }
        }
    ...
    public function startEditing()
    {
        ...
        $this->view->toplevelmodule = 'RKBulletinModule';
    
        // ensure our custom plugins are loaded
        array_push($this->view->plugins_dir, 'modules/RK/BulletinModule/Resources/views/plugins');
        ...
        if ($featureActivationHelper->isEnabled(FeatureActivationHelper::CATEGORIES, $this->objectType)) {
            ...
            $this->view->assign('categories', $categories)
                       ->assign('categoryHelper', $this->container->get('rk_bulletin_module.category_helper'));
        }
