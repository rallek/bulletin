...
abstract class AbstractThirdPartyListener implements EventSubscriberInterface
{
    ...
    public function contentGetTypes(\Zikula_Event $event)
    {
        ...
        $types->add('RKBulletinModule_ContentType_Item');
        
        // plugin for showing a list of multiple items
        $types->add('RKBulletinModule_ContentType_ItemList');
    }
     ...
     * RKBulletinModule will use this to add a javascript helper to add custom items.
     *
     * @param \Zikula_Event $event The event instance
     */
    public function getEditorHelpers(\Zikula_Event $event)
    {
        ...
        $helpers->add(
            [
                ...
                'type'   => 'javascript',
                'path'   => 'modules/RK/BulletinModule/Resources/public/js/RKBulletinModule.Finder.js'
            ]
        );
    }
    ...
    public function getTinyMcePlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'rkbulletinmodule',
                'path' => 'modules/RK/BulletinModule/Resources/docs/scribite/plugins/TinyMce/vendor/tinymce/plugins/rkbulletinmodule/plugin.js'
            ]
        );
    }
    ...
    public function getCKEditorPlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'rkbulletinmodule',
                'path' => 'modules/RK/BulletinModule/Resources/docs/scribite/plugins/CKEditor/vendor/ckeditor/plugins/rkbulletinmodule/',
                'file' => 'plugin.js',
                'img'  => 'ed_rkbulletinmodule.gif'
            ]
        );
    }
}
